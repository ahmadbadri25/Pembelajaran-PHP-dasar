    ...
    <div class="container">
        ...
        <form action="" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="Npm" id="Npm" class="form-control" required value="<?= $mhs["Npm"] ?>">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="Telp" id="Telp" class="form-control" required value="<?= $mhs["Telp"] ?>">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="Agama" id="Agama" class="form-control" required value="<?= $mhs["Agama"] ?>">
            </div>
            <div class="mb-3">
                <label for="Prodi" class="form-label">Prodi :</label>
                <input type="text" name="Prodi" id="Prodi" class="form-control" required value="<?= $mhs["Prodi"] ?>">
            </div>
